...
/* externs */
#ifdef INCLUDE_MTD_I28F128
#include "i28f128.c"
#endif

#ifdef INCLUDE_MTD_I28F320
#include "i28f320.c"
#endif

#ifdef INCLUDE_MTD_I28F256
#include "i28f256.c"
#endif

#ifdef INCLUDE_MTD_I28FXXX
#include "i28f.c"
#endif

#ifdef INCLUDE_MTD_AMDXXX
#include "amd.c"
#endif
...
#ifdef	INCLUDE_MTD_I28F320
	i28f320Identify,
#endif	/* INCLUDE_MTD_I28F320 */

#ifdef	INCLUDE_MTD_I28F128
	i28f128Identify,
#endif	/* INCLUDE_MTD_I28F128 */

#ifdef	INCLUDE_MTD_I28F256
	i28f256Identify,
#endif	/* INCLUDE_MTD_I28F256 */
...
/* locals */
LOCAL char * tffsSocket[TFFS_NUM] = {NULL}; /* name of the socket interface */
...
void flRegisterComponents (void)
    ...
    static unsigned long ulInitDone = 0;
