...
--------------------
01x,22sep04,mdo  Documentation fixes for apigen
01w,20apr04,dtr  SPR 96472 sync required when loading mask values.
01v,04apr04,rec  SPR 95018 - Aux timer hangs system
01u,24oct03,rec  change Timer 2 to highest priority for PWR MGMT
01t,24nov03,to   compilation fix and some style and spell fixes
01s,06nov03,kam  added intDisconnect() functionality
...
01l,22oct01,g_h  Change the m8260IntrDeMux function to check for interrupt 0
                 as indication for no interrupt. As long as reading the SIVEC
                 register different from 0 we have pending interrupt and
                 we need to server it, this fix SPR 71119.
...
01d,13apr99,ms_  redefine IVEC_TO_INUM and INUM_TO_IVEC to use the numbers as
                 shown in the MPC8260 user's manual
...
The default demultiplexer, m8260IntrDeMux() detects which peripheral or
...
LOCAL VOIDFUNCPTR   defaultVec;                 /* INTR3 default vector */
...
/*
 * For a given inum, return a pair of masks, one for SIMR_H and one for SIMR_L,
 * which will enable only higher priority interrupts.
 * REF: MPC8269 PowerQuiccII Family Reference Manual - Figs 4-16, 4-17
 */

LOCAL SIU_INT_MASK enableHighPriInts[] =
    {
    {0x00000000, 0x00000000},       /* interrupt 0 error - enable nothing */
    {0x003F7C06, 0xECF0264A},       /* I2C */
    {0x0FFF7F06, 0xECF0A7DA},       /* SPI */
    {0x003F7C06, 0xECF0064A},       /* RISC Timer Table */
    {0x3FFF7F06, 0xECF0E7DA},       /* SMC1 */
    {0x3FFF7F06, 0xECF0F7DA},       /* SMC2 */
    {0x00077C06, 0xECF00048},       /* IDMA1 */
    {0x001F7C06, 0xECF00448},       /* IDMA2 */
    {0x00FF7E06, 0xECF0A64A},       /* IDMA3 */
    {0x0FFF7F06, 0xECF0A74A},       /* IDMA4 */
    {0x00077C06, 0xECF00008},       /* SDMA Bus Error */
    {0xFFFFFFFF, 0xFFFFFFEA},       /* interrupt 11 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFEA},       /* Timer 1 - not used */
    {0x00000000, 0x00000000},       /* Timer 2 - system timer, - enable nothing */
    {0xFFFFFFFF, 0xFFFFFFEA},       /* Timer 3 - not used */
    {0x07FF7F06, 0xECF0A748},       /* Timer 4 */
    {0x00000000, 0x00000008},       /* TMCNT */
    {0x00000004, 0x00000008},       /* PIT */
    {0x00000000, 0x00000008},       /* PCI Interrupt */
    {0x00000006, 0x00000008},       /* IRQ1 XXXX */
    {0x00004006, 0xEC000008},       /* IRQ2 */
    {0x00006006, 0xEC000008},       /* IRQ3 */
    {0x00007006, 0xEC000008},       /* IRQ4 */
    {0x00007806, 0xEC000008},       /* IRQ5 */
    {0x00FF7C06, 0xECF0A64A},       /* IRQ6 */
    {0x00FF7E06, 0xECF0A74A},       /* IRQ7 */
    {0xFFFFFFFF, 0xFFFFFFEA},       /* interrupt 26 reserved - enable everything */
    {0x00004006, 0x00000008},       /* FCC1 */
    {0x00004006, 0x80000008},       /* FCC2 */
    {0x00004006, 0xC0000008},       /* FCC3 */
    {0xFFFFFFFF, 0xFFFFFFEA},       /* interrupt 30 reserved - enable everything */
    {0x00004006, 0xE0000008},       /* MCC1 */
    {0x00004006, 0xE8000008},       /* MCC2 */
    {0xFFFFFFFF, 0xFFFFFFDA},       /* interrupt 33 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFDA},       /* interrupt 34 reserved - enable everything */
    {0x00007C06, 0xEC000008},       /* SCC1 */
    {0x00007C06, 0xEC800008},       /* SCC2 */
    {0x00007C06, 0xECC00008},       /* SCC3 */
    {0x00007C06, 0xECE00008},       /* SCC4 */
    {0xFFFFFFFF, 0xFFFFFFDA},       /* interrupt 39 reserved - enable everything */
    {0x00007C06, 0xECF00008},       /* PC15 */
    {0x00017C06, 0xECF00008},       /* PC14 */
    {0x00037C06, 0xECF00008},       /* PC13 */
    {0x00077C06, 0xECF00448},       /* PC12 */
    {0x000F7C06, 0xECF00448},       /* PC11 */
    {0x001F7C06, 0xECF0064A},       /* PC10 */
    {0x003F7C06, 0xECF0A64A},       /* PC9 */
    {0x007F7C06, 0xECF0A64A},       /* PC8 */
    {0x00FF7F06, 0xECF0A74A},       /* PC7 */
    {0x01FF7F06, 0xECF0A74A},       /* PC6 */
    {0x03FF7F06, 0xECF0A74A},       /* PC5 */
    {0x07FF7F06, 0xECF0A74A},       /* PC4 */
    {0x0FFF7F06, 0xECF0E7DA},       /* PC3 */
    {0x1FFF7F06, 0xECF0E7DA},       /* PC2 */
    {0x3FFF7F06, 0xECF0FFDA},       /* PC1 */
    {0x7FFF7F06, 0xECF0FFDA},       /* PC0 */
    {0xFFFFFFFF, 0xFFFFFFDA},   /* interrupt 56 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFDA},   /* interrupt 57 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFDA},   /* interrupt 58 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFDA},   /* interrupt 59 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFDA},   /* interrupt 60 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFDA},   /* interrupt 61 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFDA},   /* interrupt 62 reserved - enable everything */
    {0xFFFFFFFF, 0xFFFFFFDA}    /* interrupt 63 reserved - enable everything */
    };
...
LOCAL STATUS    m8260IntDisconnect (VOIDFUNCPTR *, VOIDFUNCPTR, int);
...
*
* NOTE: All interrupts from the SIU unit are enabled, CICR is setup so
...
STATUS m8260IntrInit (void)
    ...
    if (_func_intDisconnectRtn == NULL)
        _func_intDisconnectRtn = m8260IntDisconnect;
...
/*******************************************************************************
*
* m8260IntDisconnect - disconnect a routine from an interrupt
*
* This routine disconnects any C or assembly routine from one of the multiple
* sources of interrupts.
*
* <vector> types are defined in h/drv/intrClt/m8260Intr.h.
*
...
LOCAL STATUS m8260IntDisconnect
    (
    ...
    /* set the entry back to the default */

    intrVecTable[(int)(vector)].vec = (VOIDFUNCPTR)defaultVec;
    intrVecTable[(int)(vector)].arg = 0;
    intrVecTable[(int)(vector)].cnt = 0;
...
*
* This routine must be bound to an external interrupt exception (vector 0x500).
...
* this function's responsibility to unlock the interrupt.
*
* RETURNS: N/A
*
* ERRNO
...
LOCAL void m8260IntrDeMux (void)
	...
	/* New: read last written value into 'dummy' to enforce a sync */ 
	dummy = * M8260_SIMR_H(immrVal); 
...
*
* This routine enables the indicated interrupt by setting the appropriate
...
int intCounterGet (int intNum )
{
	 return   intrVecTable[intNum].cnt; 
}
void intCounterClear (int intNum )
{
	 intrVecTable[intNum].cnt = 0; 
}
...
*
* This routine masks the bit in the SIMASK register corresponding to
