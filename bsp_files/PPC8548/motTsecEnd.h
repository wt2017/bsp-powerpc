...
#define MOT_TSEC_FIFO_TX_STARVE_DEFAULT        (256) 
#define MOT_TSEC_FIFO_TX_STARVE_OFF_DEFAULT    (384) 
...
/* Set extraction length to be max frame size */
#define MOT_TSEC_ATTRELI_EL_DEFAULT (MOT_TSEC_ATTRELI_EL(0x20) | \
