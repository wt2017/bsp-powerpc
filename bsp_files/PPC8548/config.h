...
--------------------
01i,30aug06,dtr  Support latest silicon and board revisions.
...
"mottsec(0,0)host:vxWorks h=192.168.0.1 e=192.168.0.2 u=vxworks pw=vxworks f=0x0"
#define INCLUDE_END
/* MMU and CACHE */
...
#define INCLUDE_TERTIARY_TSEC_END
...
#define PCI_LAW_BASE             0x80000000       /* PCI LAW window */
#define PCI_LAW_SIZE             0x10000000       /* PCI LAW size   */

#define PCI_MEM_SIZE             0x02000000        /* 64 MB */
#define PCI_MEMIO_SIZE           0x02000000        /* 64 MB */
#define PCI_IO_SIZE              0x02000000        /* 64 MB */
...
#define PCI_MMU_TLB_SZ           _MMU_TLB_SZ_64M

#if (PCI_MEM_SIZE == 0x04000000)
#define PCI_MEM_SIZE_MASK        PCI_ATTR_WS_64M
#endif 

#if (PCI_MEM_SIZE == 0x02000000)
#define PCI_MEM_SIZE_MASK        PCI_ATTR_WS_32M
#endif 
...
#define TOTAL_FLASH_SIZE                0x04000000
/* LBC CS2 - SDRAM */
...
#define ROM_TEXT_ADRS 0xFFF4f100
#define ROM_BASE_ADRS 0xFFF4f000
#define ROM_SIZE      0x000c0000

#define USER_RESERVED_MEM 0x000000

#ifndef	_ASMLANGUAGE
extern int NSPsntpsClockHook(); 
#endif
