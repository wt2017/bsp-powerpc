...
#define END_LOAD_FUNC_TER       sysMotTsecEndLoad
#define END_BUFF_LOAN_TER       SYS_END_BUFF_LOAN_TER  
...
#endif 
#if defined(INCLUDE_TERTIARY_TSEC_END)
    {2, END_LOAD_FUNC_TER, END_LOAD_STRING, END_BUFF_LOAN_TER, NULL},
#endif 
