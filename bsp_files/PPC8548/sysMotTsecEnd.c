...
#define MOT_TSEC_PHY_ADDRS_DEV_3    2
#define MOT_TSEC_PHY_ADDRS_DEV_4    3
...
UINT32 sysMotTsecNumByUnit[MOT_TSEC_MAX_DEVS] = {MOT_TSEC_DEV_1, MOT_TSEC_DEV_2,MOT_TSEC_DEV_3,MOT_TSEC_DEV_4};
...
* .IP <CCSBAR>
* The MPC85xx Internal memory base address. eg.0xe0000000
* .IP <tsecNum>
    ...
    if (strlen (pParamStr) == 0)
        ...
        */
        ...
        usrFlags = MOT_TSEC_USR_STAT_ENABLE |
                   MOT_TSEC_USR_MODE_MII;

	    
        sysMotTsecEnetAddrGet(unit, enet);

printf("mottsec%d MAC addr: %02x-%02x-%02x-%02x-%02x-%02x\r\n",
       unit, enet[0],enet[1],enet[2],enet[3],enet[4],enet[5]);
