...
#define FEI_LONG_RD(addr, value)                                        \
    (((UINT32) (value)) = (UINT32) FEI_SWAP_LONG (((* (addr)) & 0xffffffff)))
#endif /* FEI_LONG_RD */
 
#ifndef FEI_WORD_RD
#define FEI_WORD_RD(addr, value)                                        \
    (((UINT16) (value)) = (UINT16) FEI_SWAP_WORD (((* (addr)) & 0xffff)))
#endif /* FEI_WORD_RD */
 
#ifndef FEI_BYTE_RD
#define FEI_BYTE_RD(addr, value)                                        \
    (((UINT8) (value)) = (UINT8) (((* (addr)) & 0x000000ff)))
#endif /* FEI_BYTE_RD */
...
if (FEI_INT_ENABLE (pDrvCtrl))                                              \
    ((*(FUNCPTR) (FEI_INT_ENABLE (pDrvCtrl))) (pDrvCtrl->board.vector))
...
if (FEI_INT_DISABLE (pDrvCtrl))                                             \
    ((*(FUNCPTR) (FEI_INT_DISABLE (pDrvCtrl))) (pDrvCtrl->board.vector))
