...
--------------------
01q,21jun05,pcm  removed #include "cbioLib.h"
01p,06may05,jb3  New function tffsDrvOptionsSet for Datalight.
01o,06oct04,nrv  Reverted back changes to tffsIoctl 
01n,29jul04,alr  added (EAN) patch for device locking
01m,29jul04,alr  added (EAN) patch to free pTffsDev on error
